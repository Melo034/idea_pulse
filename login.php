...
<body class="bg-black">
    <section class="text-rose-500">
        ...
        <div class="w-full h-screen flex flex-col relative space-y-8 h-screen p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
            ...
            <form action="./backend/login.php" method="POST" class="w-full max-w-sm md:w-1/2 border border-rose-600 p-10 bg-black shadow-xl shadow-rose-600 border-rose-600 ">
                ...
                <div>
                    <div class="flex flex-col mb-3">
                        <label for="name" class="text-rose-500">Email</label>
                    ...
                    <div class='flex flex-col text-gray-600 py-2' x-data="{ show: true }">
                        <div class="flex flex-col mb-3">
                            ...
                            <div class="relative mt-2">
                                ...
                                <input class="w-full min-w-0 mt-2 px-3 rounded-lg py-2 bg-gray-800 border border-gray-900 focus:border-rose-500 focus:outline-none focus:bg-gray-800 focus:text-rose-500" :type="show ? 'password' : 'text'" id="password" name="password" autocomplete="current-password" placeholder="Enter your password" />
                ...
                <div class="text-right mt-2">
                    <a href="./forget_password.php" class="text-sm font-semibold text-white hover:text-rose-700 focus:text-rose-700">Forgot Password?</a>
                </div>
